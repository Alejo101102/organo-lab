...
export function PreventionEye({ physics = true, rotate = false, ...props }) {
    const { nodes, materials } = useGLTF('/models-3d/cataratas/prevention-eye.glb')
    ...
    const content = (
        ...
        <mesh
            castShadow
            receiveShadow
            geometry={nodes.PreventionEye.geometry}
            material={materials.PreventionEyeMaterial}
        />
        </group>
    )
...
useGLTF.preload('/models-3d/cataratas/prevention-eye.glb')